...
var wikidata = {
	...
	"Blackhat Post":        {id:101,times:":00 - :29",sub:["submit"]},
	"Blushing Brides":      {id:103,sub:["join","samples"]},
	"Building A Future":     {id:106,times:":15 - :29",sub:["invest"]},
	"Cavity Lease":         {id:108,sub:["submit"]},
	"Chevron":             {id:110,times:":30 - :59"},
	"Crisis Calls":         {id:111,sub:["account","resetpassword"]},
	"Cry Bitch":            {id:114,times:":00 - :29",sub:["login","waiting"]},
	"Crystal Guild":        {id:117,times:":30 - :44",sub:["welcome"]},
	"Doctor Murder":        {id:119},
	"Dont Waste It":         {id:120,sub:["holdit","no","yes"]},
	"Doughy":              {id:124},
	"Drug Tickets":         {id:125,times:":00 - :29",sub:["checkout","error"]},
	"Eat My Shit":         {id:128,times:":15 - :29",sub:["faq","questions","secret"]},
	"Encrave":             {id:132,sub:["evident","gateopen"]},
	"finalStanding":       {id:135,times:":30 - :59"},
	"FindLove":            {id:136,times:":00 - :14"},
	"Forever Friend":       {id:137,sub:["order"]},
	"Forsaken Gifts":       {id:139,times:":00 - :14",sub:["gifts","order"]},
	"I Am Here":             {id:142,times:":30 - :44"},
	"Jakobs Sink":          {id:143},
	"Keep Sake":            {id:144,times:":30 - :44",sub:["contact","thesearch"]},
	"Kill For Me":           {id:147,times:":00 - :29",sub:["instructions","targets"]},
	"Lab Monkey":           {id:150,times:":30 - :59",sub:["catalog","error","sign-in"]},
	"LostTapes":           {id:154,sub:["page2","purchase"]},
	"MamaBruguglio":       {id:157,times:":00 - :29"},
	"Mors N More Market":     {id:158,times:":00 - :14",sub:["menu","order","ordersent"]},
	"Oneless":             {id:162},
	"Order Of Nine":         {id:163,times:":00 - :14",sub:["join"]},
	"Overnight Success":    {id:165,times:":15 - :29",sub:["purchase"]},
	"Prohibited Stockpile": {id:167,sub:["nocontent"]},
	"Red Handed":           {id:169,times:":00 - :29",sub:["login","post1","post2","post4","post6"]},
	"Red Triangle":         {id:175},
	"Ring Ring":            {id:176,sub:["answer"]},
	"Shelter":             {id:178,times:":30 - :44",sub:["donate","events"]},
	"Symphoros Chosen":     {id:181,sub:["live","sendlinks"]},
	"Synapse Decay":        {id:184,sub:["getmoney","myfriends","occasionally","succulentmeal"]},
	"Tango Down":           {id:189,sub:["hire","payment","results"]},
	"Thanks For Visiting!":    {id:193,sub:["bar","connected","creepy","fakemain","jolly","plug","portal","sleeptalk","slide2","smile","ulike","vision"]},
	"The Bomb Maker":        {id:206},
	"The Grey":             {id:207,times:":30 - :59",sub:["centrum","deddd","inanis","interius","latus"]},
	"The Hall":             {id:213,times:":45 - :59"},
	"The Hole":             {id:214},
	"The Light Within":      {id:215,sub:["saved"]},
	"The Loogaroo":         {id:217,sub:["locations"]},
	"The Prey":             {id:219,times:":00 - :14"},
	"Time Sharing":         {id:220,sub:["packages","watch"]},
	"TRACK06":             {id:223},
	"ViaMarisRoute":       {id:224,times:":00 - :29",sub:["order","secondpage","thirdpage"]},
	"VoluVision":          {id:228,sub:["purchase","testimonials"]},
	"World Wide Workers":    {id:231,sub:["about","submit"]},
	"You There?":            {id:234,times:":30 - :44"}
};
var wifidata = [
...
function setup() {//Prepares website lists and appearance
	try {
		//Generate wifi block buttons
		/*wifidata.forEach(function (data,index) {
			var button = document.createElement("button");
			document.getElementById("wifi_list").appendChild(button);
			button.innerHTML = "<i class='" + ((data.level == 0) ? 'icon-square-o':'icon-square') + "'></i> " + data.name;
		...
		/*tenantdata.forEach(function (data,index) {
			...
			button.innerHTML = "<i class='" + ((data.doll == 0) ? 'icon-square-o':'icon-square') + "'></i> " + data.name;
			button.id = `tenant_listbutton${index}`;
			button.addEventListener("click",function(){tenant_update(index)});
		});*/
